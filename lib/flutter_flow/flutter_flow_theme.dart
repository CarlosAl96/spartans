...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF3A3A3A);
  late Color secondary = const Color(0xFFAD202F);
  late Color tertiary = const Color(0xFF0E0E0E);
  late Color alternate = const Color(0xFF253E4A);
